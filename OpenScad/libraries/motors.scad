...
module main17(){color("slategray"){translate([0.1,0.1,8.75])
    linear_extrude(20.5){polygon(points=[[7.715,0],[21.11,0],[21.11,21.11],[0,21.11],[0,7.715],[1.598,5.479],[3.431,3.432],[5.478,1.599]]);}}}
//
module nema17(){
    //bottom
    ends17();
    ...
    //top
    translate([0,0,29.25]) ends17(hole=1);
    translate([42.42,42.42,29.25]) rotate([0,0,180]) ends17(hole=1);
    translate([42.42,0,29.25]) rotate([0,0,90]) ends17(hole=1);
    translate([0,42.42,29.25]) rotate([0,0,270]) ends17(hole=1);
    color("silver"){translate([21.21,21.21,38]) cylinder(r=11,h=2);
        difference(){
            translate([21.21,21.21,40]) cylinder(r=2.5,h=22);
            translate([14.21,18.71,47]) cube([5,5,16]);}}}
//
//NEMA 23
